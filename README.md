...
# ৪. SELECT স্টেটমেন্ট এ WHERE ক্লজ
...
PostgreSQL-এ, ডাটাবেস স্কিমা হল একটি নেইমড কন্টেইনার যা টেবিল, ভিউ, ফাংশন, ইনডেক্স ইত্যাদির মতো ডাটাবেস অবজেক্ট ধারণ করে। এটি আমাদের রিলেটেড ডাটাবেস অবজেক্টগুলিকে একসাথে গ্রুপ আকারে রাখতে দেয়। 



## স্কিমা ≠ ডাটাবেস:
একটি ডাটাবেসে একাধিক স্কিমা থাকতে পারে।
একটি স্কিমাতে একাধিক টেবিল এবং অন্যান্য অবজেক্ট থাকতে পারে।

ডাটাবেসকে একটি ফোল্ডার হিসাবে এবং স্কিমাগুলিকে সাবফোল্ডার হিসাবে ধরা যায় যা আমাদের ফাইলগুলি (টেবিল, ভিউ, ইত্যাদি) সংগঠিত রাখে।

#### <code>উদাহরণ:</code> 
একটি ডাটাবেস company_db-তে পাবলিক, hr, সলেস ইত্যাদির মতো স্কিমা থাকতে পারে।


## লজিক্যাল গ্রুপিং:
স্কিমা আমাদেরকে নির্দিষ্ট নেমস্পেসের অধীনে রিলাটেড অবজেক্টগুলিকে সংরক্ষন করতে দেয়। 

#### <code>উদাহরণ:</code> 
```bash
    hr.employees, finance.transactions.
```


## নিরাপত্তা ও অ্যাক্সেস নিয়ন্ত্রণ:
স্কিমাগুলিতে আমরা অ্যাক্সেস মঞ্জুর বা প্রত্যাহার করতে পারি। 

#### <code>উদাহরণ:</code> 
শুধুমাত্র অ্যাকাউন্টিং ব্যবহারকারীরা ফাইন্যান্স স্কিমা অ্যাক্সেস করতে পারবে।


## নামকরণের দ্বন্দ্ব এড়ায়:
দুটি টেবিলের একই নাম থাকতে পারে যদি তারা ভিন্ন স্কিমায় থাকে।

#### <code>উদাহরণ:</code> 
hr.employees vs finance.employees


## ডিফল্ট স্কিমা:
যখন আমরা একটি নতুন PostgreSQL ডাটাবেস তৈরি করি, তখন এটি স্বয়ংক্রিয়ভাবে public নামে একটি ডিফল্ট স্কিমায় অন্তর্ভুক্ত হয়।
